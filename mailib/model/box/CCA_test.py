...
if __name__ == "__main__":
    ...
    var = "Ta C"
    AttSta = att_sta('/home/thomas/PhD/obs-lcb/staClim/database_metadata.csv')
    ...
    West_stanames =AttSta.get_sta_id_in_metadata(['West'])
    East_stanames =AttSta.get_sta_id_in_metadata(['East'])
